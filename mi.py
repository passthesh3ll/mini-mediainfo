...
def main():
    ...
    parser.add_argument('-fnal', '--filter_not_audio_language', type=str, help='show only files without specific audio language', metavar='<language_iso639>', action='store')
    parser.add_argument('-fnsl', '--filter_not_subtitle_language', type=str, help='show only files without specific subtitle language', metavar='<language_iso639>', action='store')
